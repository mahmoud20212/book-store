...
@section('heading', 'عرض الناشرين')

@section('content')
  <a href="{{ route('publishers.create') }}" class="btn btn-primary">
    <i class="fas fa-plus"></i>  أضف ناشراً جديداً
  </a>
  <hr>
  <div class="row">
    <div class="col-md-12">
        ...
        <tbody>
          @foreach($publishers as $publisher)
            <tr>
              ...
              <td>
                <a href="{{ route('publishers.edit', $publisher->id) }}" class="btn btn-info btn-sm">
                  <i class="fa fa-edit"></i> تعديل
                </a>
                <form action="{{ route('publishers.destroy', $publisher->id) }}" method="post" class="d-inline-block">
                  @csrf
                  @method('DELETE')
